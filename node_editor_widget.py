...
class NodeEditorWidget(QWidget):
    ...
    def addNodes(self):
        ...
        node1 = Node(self.scene, "OR GATE", inputs=[0, 0, 0], outputs=[1, 5])
        node2 = Node(self.scene, "AND GATE", inputs=[3, 3, 3], outputs=[1])
        node3 = Node(self.scene, "XOR GATE", inputs=[2, 2, 2], outputs=[1])
